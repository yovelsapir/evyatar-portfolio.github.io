...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"script.e78172f1.js":[function(require,module,exports) {
var define;
...
parcelRequire = function (e, r, t, n) {
  ...
  "wFJa": [function (require, module, exports) {
    module.exports = "Blackmoji2.3c7fd999.gif";
  }, {}],
  "iIGx": [function (require, module, exports) {
    module.exports = "Whitemoji123.9fd2c91c.gif";
  }, {}],
  ...
  "mpVp": [function (require, module, exports) {
    ...
    s.start(), document.querySelector("main").style.display = "none", s.on("done", function () {
      document.querySelector("main").style.display = "block", window.scrollTo(0, 1), setTimeout(function () {
        $(".arrow").css("opacity", "1");
      }, 2500), $(".hiddenclass").css("display", "block"), $(".hiddenclass").css("display", "none");
    }), window.addEventListener("load", function () {
      window.innerWidth > 480 ? $("[data-src=Whitemoji2]")[0].setAttribute("src", i) : ($("[data-src=Whitemoji2]")[0].setAttribute("src", o), $(".hiddenclass").css("display", "none"));
    }, !1);

    var n = require("emergence.js"),
        r = n(),
        a = "home-group",
    ...
    function k() {
      ...
      function o(t, i, o, s) {
        this.position = new e(t, i), this.mass = o, this.drag = s, this.force = new e(0, 0), this.velocity = new e(0, 0), this.AddForce = function (t) {
          this.force.Add(t);
          ...
          var o = new e(this.force.x, this.force.y),
              ...
              n = new e(this.velocity.x, this.velocity.y);
          return n.Mul(this.drag * this.mass * s), o.Sub(n), o;
        };
      }

      function s(o, n) {
        this.pos = new e(o, n), this.rotationSpeed = 600 * w() + 800, this.angle = t * w() * 360, this.rotation = t * w() * 360, this.cosA = 1, this.size = 5, this.oscillationSpeed = 1.5 * w() + .5, this.xSpeed = 40, this.ySpeed = 60 * w() + 50, this.corners = new Array(), this.time = w();
        var r = m(w() * (i.length - 1));
        this.frontColor = i[r][0], this.backColor = i[r][1];

        for (var a = 0; a < 4; a++) {
          var c = v(this.angle + t * (90 * a + 45)),
              h = g(this.angle + t * (90 * a + 45));
          this.corners[a] = new e(c, h);
        }

        this.Update = function (i) {
          this.time += i, this.rotation += this.rotationSpeed * i, this.cosA = v(t * this.rotation), this.pos.x += v(this.time * this.oscillationSpeed) * this.xSpeed * i, this.pos.y += this.ySpeed * i, this.pos.y > s.bounds.y && (this.pos.x = w() * s.bounds.x, this.pos.y = 0);
      ...
      function n(s, r, a, c, h, l, d, u) {
        this.particleDist = c, this.particleCount = a, this.particleMass = d, this.particleDrag = u, this.particles = new Array();
        var y = m(w() * (i.length - 1));
        this.frontColor = i[y][0], this.backColor = i[y][1], this.xOff = v(t * l) * h, this.yOff = g(t * l) * h, this.position = new e(s, r), this.prevPosition = new e(s, r), this.velocityInherit = 2 * w() + 4, this.time = 100 * w(), this.oscillationSpeed = 2 * w() + 2, this.oscillationDistance = 40 * w() + 40, this.ySpeed = 40 * w() + 80;

        for (var x = 0; x < this.particleCount; x++) {
          this.particles[x] = new o(s, r - x * this.particleDist, this.particleMass, this.particleDrag);
        }
        ...
        this.Update = function (t) {
          ...
          var o = this.prevPosition.x - this.position.x,
              s = this.prevPosition.y - this.position.y,
              r = f(o * o + s * s);
          ...
          this.position.y = -w() * n.bounds.y, this.position.x = w() * n.bounds.x, this.prevPosition = new e(this.position.x, this.position.y), this.velocityInherit = 2 * w() + 4, this.time = 100 * w(), this.oscillationSpeed = 2 * w() + 1.5, this.oscillationDistance = 40 * w() + 40, this.ySpeed = 40 * w() + 80;
          var t = m(w() * (i.length - 1));
          this.frontColor = i[t][0], this.backColor = i[t][1], this.particles = new Array();

          for (var s = 0; s < this.particleCount; s++) {
            this.particles[s] = new o(this.position.x, this.position.y - s * this.particleDist, this.particleMass, this.particleDrag);
          }
        }, this.Draw = function (t) {
          for (var i = 0; i < this.particleCount - 1; i++) {
            var o = new e(this.particles[i].position.x + this.xOff, this.particles[i].position.y + this.yOff),
                s = new e(this.particles[i + 1].position.x + this.xOff, this.particles[i + 1].position.y + this.yOff);
            this.Side(this.particles[i].position.x, this.particles[i].position.y, this.particles[i + 1].position.x, this.particles[i + 1].position.y, s.x, s.y) < 0 ? (t.fillStyle = this.frontColor, t.strokeStyle = this.frontColor) : (t.fillStyle = this.backColor, t.strokeStyle = this.backColor), 0 == i ? (t.beginPath(), t.moveTo(this.particles[i].position.x * p, this.particles[i].position.y * p), t.lineTo(this.particles[i + 1].position.x * p, this.particles[i + 1].position.y * p), t.lineTo(.5 * (this.particles[i + 1].position.x + s.x) * p, .5 * (this.particles[i + 1].position.y + s.y) * p), t.closePath(), t.stroke(), t.fill(), t.beginPath(), t.moveTo(s.x * p, s.y * p), t.lineTo(o.x * p, o.y * p), t.lineTo(.5 * (this.particles[i + 1].position.x + s.x) * p, .5 * (this.particles[i + 1].position.y + s.y) * p), t.closePath(), t.stroke(), t.fill()) : i == this.particleCount - 2 ? (t.beginPath(), t.moveTo(this.particles[i].position.x * p, this.particles[i].position.y * p), t.lineTo(this.particles[i + 1].position.x * p, this.particles[i + 1].position.y * p), t.lineTo(.5 * (this.particles[i].position.x + o.x) * p, .5 * (this.particles[i].position.y + o.y) * p), t.closePath(), t.stroke(), t.fill(), t.beginPath(), t.moveTo(s.x * p, s.y * p), t.lineTo(o.x * p, o.y * p), t.lineTo(.5 * (this.particles[i].position.x + o.x) * p, .5 * (this.particles[i].position.y + o.y) * p), t.closePath(), t.stroke(), t.fill()) : (t.beginPath(), t.moveTo(this.particles[i].position.x * p, this.particles[i].position.y * p), t.lineTo(this.particles[i + 1].position.x * p, this.particles[i + 1].position.y * p), t.lineTo(s.x * p, s.y * p), t.lineTo(o.x * p, o.y * p), t.closePath(), t.stroke(), t.fill());
          }
        }, this.Side = function (t, i, e, o, s, n) {
          return (t - e) * (n - o) - (i - o) * (s - e);
        };
      }
      ...
      e.Lerp = function (t, i, o) {
      ...
      }, s.bounds = new e(0, 0), n.bounds = new e(0, 0), (r = {}).Context = function (t) {
        var i = 0,
        ...
        for (n.bounds = new e(c, h), i = 0; i < 11; i++) {
          d[i] = new n(w() * c, -w() * h * 2, 30, 8, 8, 45, 1, .05);
        }

        var u = new Array();

        for (s.bounds = new e(c, h), i = 0; i < 95; i++) {
          u[i] = new s(w() * c, w() * h);
        }

        this.resize = function () {
          c = a.offsetWidth, h = a.offsetHeight, o.width = c * p, o.height = h * p, s.bounds = new e(c, h), n.bounds = new e(c, h);
        }, this.start = function () {
          this.stop();
          this.update();
        }, this.stop = function () {
    ...
    function A(t, i, e) {
      if (!u["".concat(i).concat(e)]) {
        var o = document.createElement("a"),
            s = document.createTextNode(t);
        return o.appendChild(s), o.setAttribute("href", i), o.classList.add("btn"), document.querySelector("#".concat(e, " .button-group")).appendChild(o), u["".concat(i).concat(e)] = !0, o;
      }
    ...
    function T(t, i) {
      ...
      if (e && !e.classList.contains("gallery-active")) {
        ...
        e.addEventListener("click", function () {
          ...
          ++a >= s ? (e.style[o] = -r + "px", a = 0) : e.style[o] = a == s - 1 ? "0px" : t + n / s + "px";
        });
      }
    }
    ...
    !function (t) {
      ...
      x = t.requestAnimationFrame || t.webkitRequestAnimationFrame || function (t) {
        var e = S(),
            o = Math.max(0, 16 - (e - i)),
            s = setTimeout(t, o);
        return i = e, s;
      ...
      C(c, 1), document.querySelector("#".concat(a, " .what-you-can-do-btn")).remove(), document.querySelector("#".concat(a, " .show-me-your-work-btn")).remove(), T(".gallery-block-show-me-your-work");
      var t = A("What can you do?", "#what-you-can-do-group", c);
      t && t.addEventListener("click", function () {
        M(t), C(h, 2);
        var i = A("How can I contact you?", "#contact-group", h);
        i && i.addEventListener("click", function () {
          M(i), C(d, 3), $("#confetti").addClass("opa"), k();
        });
      });
    }), document.querySelector("#".concat(a, " .what-you-can-do-btn")).addEventListener("click", function () {
      C(h, 1), document.querySelector("#".concat(a, " .show-me-your-work-btn")).remove(), document.querySelector("#".concat(a, " .what-you-can-do-btn")).remove();
      var t = A("Show your work", "#show-me-your-work-group", h);
      t.addEventListener("click", function () {
        M(t), C(c, 2), T(".gallery-block-show-me-your-work");
        var i = A("How can I contact you?", "#contact-group", c);
        i.addEventListener("click", function () {
          M(i), C(d, 3), $("#confetti").addClass("opa"), k();
        });
      });
    }), T(".gallery-block-home-group"), r.init({
      container: window,
      reset: !1,
      handheld: !0,
      throttle: 25,
      ...
      $(this).scrollTop() > 50 ? ($(".profile.animate").addClass("smaller"), $(".frame").addClass("animatef"), $(".arrow").addClass("nothing")) : ($(".profile.animate").removeClass("smaller"), $(".frame").removeClass("animatef"), $(".arrow").removeClass("nothing"));
      ...
      !function () {
        ...
        0 == e && (e = 12);
        i < 12 && (s = "AM");
        document.getElementById("currentTime").innerHTML = e + ":" + o + " " + s;
      }();
    };
    var q = document.querySelector('.theme-switch input[type="checkbox"]');

    function E(t) {
      t.target.checked ? (document.documentElement.setAttribute("data-theme", "dark"), $(".profile").attr("src", src = "".concat(e)), $(".profile").css("mix-blend-mode", "screen"), $(".profile").attr("src", src = "".concat(e)), $("#imgi1, #imgi2, #imgi3").css("display", "none"), $("#imgi1-dark, #imgi2-dark, #imgi3-dark").css("display", "block")) : (document.documentElement.setAttribute("data-theme", "light"), window.innerWidth > 480 ? $(".profile").attr("src", src = "".concat(i)) : $(".profile").attr("src", src = "".concat(o)), $(".profile").css("mix-blend-mode", "multiply"), $("#imgi1, #imgi2, #imgi3").css("display", "block"), $("#imgi1-dark, #imgi2-dark, #imgi3-dark").css("display", "none"));
    }

    q.addEventListener("change", E, !1);
    var L = new URL(window.location.href),
        D = new URLSearchParams(L.search),
        P = [D.get("name"), D.get("secret")],
        I = P[0],
        B = P[1],
        F = I || "you";

    if (document.getElementById("companyName").textContent = "Hi ".concat(F, " ✌🏻"), "secret" === B) {
      var H = document.getElementById("showcase-my-works-secret");
      H.style.display = "flex";
    } else {
      var R = document.getElementById("showcase-my-works");
        ...
        return this.each(function (o, s) {
          function n() {
            var o = t(s).outerHeight(),
                ...
                a = r.top,
                c = r.bottom;
            return e.call(s, Math.max(0, a > 0 ? Math.min(o, n - a) : Math.min(c, n)));
          }

          n(), t(i).on("resize scroll", n);
        });
      };
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","script.e78172f1.js"], null)
//# sourceMappingURL=/script.e78172f1.e8b27fbb.js.map