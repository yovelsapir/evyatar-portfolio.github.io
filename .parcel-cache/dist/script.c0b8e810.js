...
document.querySelectorAll('.group-container').forEach((el, i) => el.style.order = i); // קונפטי
    ...
    smoothAnimationButton.addEventListener('click', () => {
      ...
      if (s_whatYouCanDoButton) {
        s_whatYouCanDoButton.addEventListener('click', () => {
          ...
          const s_contactInfoButton = createButton("How do I contact you?", '#contact-group', WHAT_YOU_CAN_DO_GROUP);
...
document.querySelector(`#${HOME_GROUP} .what-you-can-do-btn`).addEventListener('click', () => {
  ...
  showMeYourWorkButton.addEventListener('click', () => {
    ...
    createGallery('.gallery-block-show-me-your-work');
    const w_smoothAnimationButton = createButton("Show me more", '#smooth-animation-group', WORK_GROUP);
    const w_contactInfoButton = createButton("How do I contact you?", '#contact-group', WORK_GROUP);
    w_smoothAnimationButton.addEventListener('click', () => {
      removeButton(w_contactInfoButton);
      removeButton(w_smoothAnimationButton);
      showPage(SMOOTH_ANIMATION_GROUP, 3);
      createGallery('.gallery-block-smooth-animation');
      const w_contactInfoButton1 = createButton("How do I contact you?", '#contact-group', SMOOTH_ANIMATION_GROUP);
...
//# sourceMappingURL=script.c0b8e810.js.map
