...
$(document).ready(function () {
  $("#pdf2").click(function () {
    // Change src attribute of 
    var image = $('.profile').attr("data-src");

    if (image = "/Whitemoji.de99c868.gif") {
      $(".profile").attr("src", $(this).data("/Blackmoji.1bfc299d.gif"));
    } else {
      $(".profile").attr("data-src", src = "/Whitemoji.de99c868.gif");
    }
  });
...
//# sourceMappingURL=script.0daa9461.js.map
