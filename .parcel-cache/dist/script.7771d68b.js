...
$(document).ready(function () {
  $("#pdf2").click(function () {
    ...
    if (image != "https://i.ibb.co/cLkzr4R/blaaaa.png") {
      $(".profile").attr("src", src = "https://i.ibb.co/cLkzr4R/blaaaa.png");
    } else {
      $(".profile").attr("src", src = "/text-delete.b0e914dc.gif");
    }
  });
});
...
//# sourceMappingURL=script.7771d68b.js.map
