...
document.querySelector(`#${HOME_GROUP} .show-me-your-work-btn`).addEventListener('click', () => {
  ...
  if (whatYouCanDoButton) {
    whatYouCanDoButton.addEventListener('click', () => {
      ...
      const w_contactInfoButton = createButton("Contact info", '#contact-group', '#contafeti', WHAT_YOU_CAN_DO_GROUP);
...
document.getElementById('contafeti').onclick = function () {
...
//# sourceMappingURL=script.a52603f9.js.map
